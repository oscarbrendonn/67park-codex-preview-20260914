...
import {mergeGeometries} from '/67park-codex-preview-20260914/island/utils/BufferGeometryUtils.js';
...
export async function loadCityProps58({scene,renderer,sample,variant}){
 ...
 const [buildings,bridge,layout,bridgeMeta]=await Promise.all([
  loader.loadAsync('/67park-codex-preview-20260914/island/city-buildings-v58.glb?v=1'),loader.loadAsync('/67park-codex-preview-20260914/island/city-bridge-v58.glb?v=1'),
